...
export default function ThankYou() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-16 py-20 md:py-24 overflow-hidden">
      {/* Animated Background */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-[#2BA55D] via-[#1E7A43] to-[#1E7A43]"
        initial={{ opacity: 0 }}
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <div className="w-32 h-32 md:w-48 md:h-48 bg-white rounded-full mx-auto flex items-center justify-center shadow-2xl">
            <svg className="w-16 h-16 md:w-24 md:h-24 text-[#2BA55D]" viewBox="0 0 90 88" fill="none">
              <path d="M21.2606 16.2016C16.5544 10.2671 10.4912 5.55026 3.58164 2.44806C2.8923 8.84556 3.23087 15.3122 4.5845 21.6027C5.97172 28.1997 8.81018 34.4052 12.8939 39.7688C17.5855 45.6769 23.6495 50.3491 30.5586 53.379C31.2628 47.022 30.9387 40.593 29.5987 34.339C28.1826 27.7498 25.3253 21.5558 21.232 16.2016H21.2606Z" fill="currentColor"/>
            </svg>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-white text-2xl md:text-3xl font-bold">agrico</p>
          <div className="w-24 h-1 bg-white" />
        </motion.div>

        <motion.p
          className="text-white text-base md:text-lg opacity-90 max-w-3xl mx-auto mb-12 leading-relaxed"
        ...
        >
          <motion.button
            className="px-8 py-4 bg-white text-[#2BA55D] rounded-full text-base md:text-lg font-bold shadow-lg"
          ...
          <motion.button
            className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-full text-base md:text-lg font-bold"
        ...
        >
          <svg className="w-6 h-6 text-[#2BA55D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
