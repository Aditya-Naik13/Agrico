...
export default function Sustainability() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen px-4 md:px-8 lg:px-16 py-20 md:py-32 bg-gray-50 overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.p
          className="text-[#4D4D4D] text-3xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight mb-16"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {[
            ...
            >
              ...
              <p className="text-[#4D4D4D] text-xl md:text-2xl lg:text-3xl">{item.label}</p>
            </motion.div>
          ))}
        </div>
        ...
        {/* Future Vision */}
        <motion.div
          className="bg-[#35CB68] rounded-3xl p-12 md:p-20 text-center relative overflow-hidden"
          initial={{ opacity: 0, y: 50 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
        ...
        >
          ...
          <div className="relative z-10">
            <motion.p
              className="text-white text-3xl md:text-4xl lg:text-5xl leading-relaxed"
              initial={{ opacity: 0 }}
      ...
      >
        <svg viewBox="0 0 90 88" fill="none" className="w-full h-full text-[#35CB68]">
