  ...
  return (
    <section ref={ref} className="relative min-h-screen px-6 md:px-12 lg:px-16 py-20 md:py-24 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-[#2BA55D] text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
            Primary<br />Research
          </h2>
          <motion.div
        ...
        <div className="max-w-4xl">
          <motion.p
            className="text-[#525252] text-base md:text-lg leading-relaxed mb-6"
          ...
          <motion.div
            className="text-[#525252] text-base md:text-lg leading-relaxed mb-12"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
          ...
          >
            ...
            <p>
              However, imports have grown 15.4% (USD 27.8 bn) in Apr-Dec 2022, over the USD 24.1 bn for Apr-Dec 2021. As a result, there has been a further increase of the surplus on the farm trade account. <span className="text-[#2BA55D] font-bold">Why is this happening?</span>
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          >
            <div>
              <p className="text-[#525252] text-xl md:text-2xl font-bold leading-tight mb-4">Rise in:</p>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-11 h-11 bg-[#2BA55D] rounded-full" />
                <p className="text-[#525252] text-base md:text-lg">Exports</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 bg-[#8AFFB2] rounded-full" />
                <p className="text-[#525252] text-base md:text-lg">Imports</p>
              </div>
            </div>

            <div>
              <h3 className="text-[#525252] text-xl md:text-2xl font-bold leading-tight mb-4">
        ...
        <div className="max-w-4xl">
          <motion.p
            className="text-[#525252] text-base md:text-lg leading-relaxed mb-16"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
            transition={{ delay: 0.6, duration: 0.6 }}
          >
            Essentially, these traditional methods had their limitations—They did not provide farmers with the level of <span className="text-[#2BA55D] font-bold">control</span> and <span className="text-[#2BA55D] font-bold">transparency</span> obtainable with modern technology. Nonetheless, these traditional methods still play a role in many communities and continue to provide farmers with an important channel to reach their customers.
          </motion.p>
        </div>
        ...
        >
          <p className="text-[#525252] text-xl md:text-2xl font-bold leading-tight text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="text-[#1A1A1A] text-xl md:text-2xl font-bold leading-tight mb-4">Contractor</h4>
            ...
            >
              ...
              <h4 className="text-[#1A1A1A] text-xl md:text-2xl font-bold leading-tight mb-4">Landlord/Moneylenders</h4>
              <p className="text-[#525252] text-sm md:text-base leading-relaxed">
            ...
            >
              ...
              <h4 className="text-[#1A1A1A] text-xl md:text-2xl font-bold leading-tight mb-4">Aggregator</h4>
              <p className="text-[#525252] text-sm md:text-base leading-relaxed">
